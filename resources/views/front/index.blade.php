...
<body>
    <div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-white">
        <div id="Top-Nav" class="flex items-center justify-between w-full px-4 mt-[60px]">
            <a href="index.html">
                <img width=150 height=150 src="{{asset('assets/images/logos/logo_tiketku.png')}}" class="flex shrink-0" alt="logo">
            </a>
            <a href="#">
                ...
                <div class="swiper-popular w-full overflow-hidden">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide !w-fit">
                            <a href="{{ route('front.details', $itemPopularTicket) }}" class="card">
                                <div
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <h3 class="font-bold text-white">{{$itemPopularTicket->name}}</h3>
                                        ...
                                        <p
                                            ...
                                            <span class="font-semibold text-xs leading-[18px]">{{ $itemPopularTicket->rating }}/5</span>
                                        </p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="swiper-slide !w-fit">
                            <a href="{{ route('front.category', $itemCategories->slug) }}" class="card">
                                <div
                                    ...
                                    <img src="{{Storage::url($itemCategories->icon)}}" class="w-6 h-6" alt="icon">
                                    <p class="font-bold text-sm leading-[21px]">{{ $itemCategories->name }}</p>
                                </div>
                            </a>
                        </div>
                        @empty
            ...
            <section id="Should-Visit" class="flex flex-col gap-3">
                ...
                <div class="swiper-visit w-full overflow-hidden">
                    <div class="swiper-wrapper">
                        ...
                        @forelse($sellers as $itemSellers)
                        <div class="swiper-slide !w-fit">
                            <a href="{{ route('front.seller_city', $itemSellers->slug) }}" class="card">
                                <div
                                    class="relative flex items-end w-[170px] h-[200px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{ Storage::url($itemSellers->photo) }}"
                                        class="absolute w-full h-full object-cover" alt="thumbnail">
                                    <div
                                        ...
                                        <div>
                                            <h3 class="font-bold text-white">{{ $itemSellers->name }}</h3>
                                            <p class="text-sm leading-[18px] text-white">{{ $itemSellers->tickets->count() }}</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="flex flex-col gap-[6px]">
                                    ...
                                    <div class="flex items-center gap-1">
                                        <img src="{{asset('assets/images/icons/location.svg')}}" class="w-[18px] h-[18px]"
                                            alt="icon">
                                        <p class="font-semibold text-xs leading-[18px]">{{ $itemNewTickets->seller->name }}</p>
                                    </div>
                                    <p class="font-bold text-sm leading-[21px] text-[#F97316]">Rp {{ number_format($itemNewTickets->price, 0, '.', '.')}}</p>
                                </div>
                            </div>
                            <p
                                class="w-fit flex shrink-0 items-center gap-[2px] rounded-full p-[6px_8px] bg-[#FFE5D3]">
                                <img src="{{asset('assets/images/icons/Star 1.svg')}}" class="w-4 h-4" alt="star">
                                <span class="font-semibold text-xs leading-[18px] text-[#F97316]">{{ $itemNewTickets->rating }}/5</span>
                            </p>
                        </div>
                    </a>
                    @empty
